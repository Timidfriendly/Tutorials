    ...
    tinymce.create('tinymce.Editor', {
        ...
        _addEvents : function() {
            ...
            if (s.custom_undo_redo) {
                ...
                // PATCHED. See:
                // http://forum.jquery.com/topic/focusin-and-focusout-method-don-t-work-on-firefox
                // http://www.tinymce.com/develop/bugtracker_view.php?id=4004
                function lostEditorFocus(e) {
                ...
                if (tinymce.isGecko) {
                    dom.bind(t.getDoc(), 'blur', lostEditorFocus);
                } else {
                    dom.bind(t.getDoc(), 'focusout', lostEditorFocus);
                }
